...
public class ZipUtils {
    ...
    public void endZip(String startFilePath,String endFile) throws FileNotFoundException {

        File file1  = new File(endFile);
        ...
        toZip(startFilePath, fileOutputStream,true);
